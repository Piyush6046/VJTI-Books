...
import landing_page_girl from '../../images/bg_overlay_2.png'
    ...
    <div className="main_container">
      <div className="left_container">
        ...
        <Button variant="outlined" sx={{px:'15px',py:'10px',
          backgroundColor:"#ffbf00",color:'black',mt:'25px',background:'transperant',borderRadius:'8px'}} onClick={()=>{navigate('/books')}}>
          <Typography fontSize={18} fontWeight={500}>BookStore</Typography>
        </Button>
      </div>
      <div>
        <img className="right_container" src={landing_page_girl} width={600}/>
      </div>
    </div>
  );
};
